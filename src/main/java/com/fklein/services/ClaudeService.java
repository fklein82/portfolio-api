...
public class ClaudeService {
    ...
    @ConfigProperty(name = "chat.api.key")
    String apiKey;

    @ConfigProperty(name = "chat.model", defaultValue = "gpt-4")
    String model;

    @ConfigProperty(name = "chat.max.tokens", defaultValue = "4096")
    int maxTokens;
    ...
    /**
     * Send a message to ChatGPT and get a streaming response
     */
    public Multi<String> streamChatCompletion(String systemPrompt, String userMessage) {
        return Multi.createFrom().emitter(emitter -> {
            try {
                ...
                // Build request body for OpenAI Chat API
                                ...
                                if (choices != null && !choices.isEmpty()) {
                                    ...
                                    if (delta != null) {
                                        ...
                                        if (content != null && !content.isEmpty()) {
                                            LOG.debug("Emitting content chunk: [" + content + "]");
    ...
    /**
     * Send a message to ChatGPT and get a non-streaming response
     */
